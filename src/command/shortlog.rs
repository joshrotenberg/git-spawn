...
/// stdin instead of the repository. This typed builder requires a revision and
/// rejects an empty revision list as [`Error::InvalidConfig`]; command builders
/// that select a stdin-reading mode can supply input with
/// [`GitCommand::stdin_bytes`].
///
