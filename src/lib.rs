...
pub use command::{
    ...
    cherry::CherryCommand, cherry_pick::CherryPickCommand, clean::CleanCommand,
    clone::CloneCommand, commit::CommitCommand, config::ConfigCommand, describe::DescribeCommand,
    diff::DiffCommand, fetch::FetchCommand, for_each_ref::ForEachRefCommand,
    format_patch::FormatPatchCommand, fsck::FsckCommand, gc::GcCommand, grep::GrepCommand,
    hash_object::HashObjectCommand, init::InitCommand,
