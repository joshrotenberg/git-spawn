...
pub use command::{
    ...
    apply::ApplyCommand, bisect::BisectCommand, blame::BlameCommand, branch::BranchCommand,
    cat_file::CatFileCommand, checkout::CheckoutCommand, cherry::CherryCommand,
    ...
    ls_files::LsFilesCommand, ls_tree::LsTreeCommand, maintenance::MaintenanceCommand,
    merge::MergeCommand, merge_base::MergeBaseCommand, mv::MvCommand, notes::NotesCommand,
    pull::PullCommand, push::PushCommand, range_diff::RangeDiffCommand, rebase::RebaseCommand,
