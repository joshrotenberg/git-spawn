...
pub use command::{
    ...
    clean::CleanCommand, clone::CloneCommand, commit::CommitCommand, config::ConfigCommand,
    ...
    reflog::ReflogCommand, remote::RemoteCommand, rerere::RerereCommand, reset::ResetCommand,
